      ...
      <div className="border-b border-slate-700 bg-slate-900/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            <Sparkles className="w-6 h-6 text-blue-400" /> Image Generator
          </h1>
          <button
          ...
          >
            <Settings2 className="w-5 h-5" /> <span className="hidden sm:inline">Settings</span>
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            <label className="block text-sm font-medium text-slate-300 mb-3">Your Prompt</label>
            <textarea
              value={prompt}
            ...
            <div className="flex gap-3 mt-4">
              ...
              >
                {isEnhancing ? <><Loader2 className="w-5 h-5 animate-spin" /> Enhancing...</> : <><Sparkles className="w-5 h-5" /> Enhance Prompt</>}
              </button>
            </div>
          </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`p-3 rounded-lg border-2 transition-all text-left ${
                        model === m.value ? 'border-blue-500 bg-blue-500/10' : 'border-slate-700 hover:border-slate-600'
                      }`}
                    >
          ...
          >
            {isGenerating ? <><Loader2 className="w-6 h-6 animate-spin" /> Generating...</> : <><Sparkles className="w-6 h-6" /> Generate Image</>}
          </button>
